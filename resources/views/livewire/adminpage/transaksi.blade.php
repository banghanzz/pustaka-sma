                        ...
                        <tbody>
                            @forelse ($detailPeminjaman as $itemPeminjaman)
                                <tr>
                                    ...
                                    <td class="align-middle">Rak {{ $itemPeminjaman->buku->rak->rak }} - Baris {{ $itemPeminjaman->buku->rak->baris }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="10" class="text-center">Tidak ada peminjaman yang menunggu persetujuan</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
